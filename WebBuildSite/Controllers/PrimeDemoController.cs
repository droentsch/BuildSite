...
namespace WebBuildSite.Controllers
{
    ...
    [StatusFilter]
    public class PrimeDemoController : Controller
    {
        ...
        public JsonResult BuildCIMVCSite()
        {
            ...
            builds.Add(_buildManager.RunBuild("Demo", "CI", "PrimeMVC"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        public JsonResult BuildCIWFSite()
        {
            IProjectBuild b = _buildManager.RunBuild("Demo", "CI", "PrimeWF");
            return SuccessResponse(b);
        }
        [HttpPost]
        public JsonResult BuildCIDBProject(bool rundg)
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Demo", "CI", "PrimeDB"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        ...
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Demo", "CI", "PrimeAPI"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        ...
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Demo", "CI", "PrimeLINK"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        public JsonResult BuildCIFileTransferProject(bool startft)
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Demo", "CI", "FileTransferService"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        public JsonResult BuildCIAll(bool rundg, bool startft)
        {
            List<IProjectBuild> builds = _buildManager.RunBuilds("Demo", "CI");
            return SuccessResponse(builds);
        }
        #endregion
