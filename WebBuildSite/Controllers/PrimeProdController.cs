...
namespace WebBuildSite.Controllers
{
    ...
    [StatusFilter]
    public class PrimeProdController : Controller
    {
        ...
        public ActionResult Default()
        {
            ...
            ViewBag.IsAuthorizedToViewProductionBuilds = false;
        ...
        public JsonResult BuildCIMVCSite()
        {
            ...
            builds.Add(_buildManager.RunBuild("Prod", "CI", "PrimeMVC"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        public JsonResult BuildCIWFSite()
        {
            IProjectBuild b = _buildManager.RunBuild("Prod", "CI", "PrimeWF");
        ...
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Prod", "CI", "PrimeDB"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        ...
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Prod", "CI", "PrimeAPI"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        ...
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Prod", "CI", "PrimeLINK"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        ...
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Prod", "CI", "FileTransferService"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        public JsonResult BuildCIAll()
        {
            List<IProjectBuild> builds = _buildManager.RunBuilds("Prod", "CI");
            return SuccessResponse(builds);
        }
        #endregion
        #region QA
        ...
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Prod", "QA", "PrimeMVC"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        public JsonResult BuildQAWFSite()
        {
            IProjectBuild b = _buildManager.RunBuild("Prod", "QA", "PrimeWF");
            return SuccessResponse(b);
        }
        [HttpPost]
        ...
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Prod", "QA", "PrimeDB"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        ...
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Prod", "QA", "PrimeAPI"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        ...
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Prod", "QA", "PrimeLINK"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        ...
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Prod", "QA", "FileTransferService"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        public JsonResult BuildQAAll()
        {
            List<IProjectBuild> builds = _buildManager.RunBuilds("Prod", "QA");
            return SuccessResponse(builds);
        }
        #endregion
        #region STAGING
        ...
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Prod", "Staging", "PrimeMVC"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        public JsonResult BuildStagingWFSite()
        {
            IProjectBuild b = _buildManager.RunBuild("Prod", "Staging", "PrimeWF");
            return SuccessResponse(b);
        }
        [HttpPost]
        ...
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Prod", "Staging", "PrimeDB"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        ...
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Prod", "Staging", "PrimeAPI"));
            return SuccessResponse(builds);
        }
        public JsonResult BuildStagingLINKSite()
        {
            List<IProjectBuild> builds = new List<IProjectBuild>();
            builds.Add(_buildManager.RunBuild("Prod", "Staging", "PrimeLINK"));
            return SuccessResponse(builds);
        }
        [HttpPost]
        public JsonResult BuildStagingAll()
        {
            List<IProjectBuild> builds = _buildManager.RunBuilds("Prod", "Staging");
            return SuccessResponse(builds);
        }
